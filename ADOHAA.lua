	...
	settings.DataStore = "fsdf234vxdfcgsdf"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
	settings.DataStoreKey = "iofsdjvoiuj42098jf0sdfj23"			 -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
	...
	settings.Moderators = {"Gamepass:12028437","Gamepass:9707407"}	-- Mods;									  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";}
	settings.Admins = {"Gamepass:12028422","Gamepass:9707445","Gamepass:9707474"}  		-- Admins; 						              Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";}
	settings.Owners = {"Gamepass:12028454","Gamepass:9726319"}       	-- Head Admins;								  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";}
	settings.Creators = {"graxy_sadlife","FunnyTerrainGo","asdasmdiom"}      -- Place Owner;								  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";}
	...
	settings.Permissions = {":script:ServerSide";":admins:ServerSide";}	-- Command permissions; 					  Format: {"Command:NewLevel"; "Command:Customrank1,Customrank2,Customrank3";}
	...
	settings.CustomRanks = {ServerSide = {"Luter155_CZ"; "Alive_Fox"; "BurntBiskit"; "logitech_mousey"; "Cardldragon1337"; "minishoes"; "masonplaz1022"; "eaucy"; "BigOlPapaFlop"; "Zaporaliscool"; "AceSkeptical"; "logitech_mousez","Doomguy_Slayerx3","Cleverdy","Group:8101695:1"};};	-- List of custom AdminLevel ranks			  Format: {RankName = {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";};} 
	...
	settings.Trello_Primary = "MH9YqR1i"; 		      -- Primary Trello board
	settings.Trello_Secondary = {"1R3o1x6j"}; 		  -- Secondary Trello boards (read-only)		Format: {"BoardID";"BoardID2","etc"}
	settings.Trello_AppKey = "e89934d62dcf95c26d8618338881fbc8";              -- Your Trello AppKey						  	Link: https://trello.com/app-key	
	settings.Trello_Token = "4ef9eac81fad61a1c9d707b8d192071b3fe6a6588d0b33e6605e1c68d3f7713c";               -- Trello token (DON'T SHARE WITH ANYONE!)    Link: https://trello.com/1/connect?name=Trello_API_Module&response_type=token&expires=never&scope=read,write&key=YOUR_APP_KEY_HERE
