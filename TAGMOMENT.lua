...
remote.OnServerEvent:connect(function(Player)
	...
	elseif Player.Name == "Migunoo" then
		...
		role.Text = "if lost return to dumpster" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.JosefinSans
	...
	elseif Player.Name == "AlastairLancaster" then
		...
		role.TextStrokeColor3 = Color3.new(0, 0, 0)
		role.TextColor3 = Color3.new(0,0,0)
		role.Text = "Random Bloke" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.JosefinSans
	...
	elseif Player.Name == "XLNullified" then
		...
		name.Text = "Not Citizen"
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.new(0,0,0)
		role.TextColor3 = Color3.new(0.666667, 0.333333, 1)
		role.Text = 'The Purple Deer' -- add ur rank what u want it 2 be called [by rigs]
	...
	elseif Player.Name == "ChiefEugene" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.new(1,1,1)
		name.TextColor3 = Color3.new(0,0,0)
		name.Font = Enum.Font.PermanentMarker
		...
		role.TextColor3 = Color3.new(0,0,0)
		role.Font = Enum.Font.PermanentMarker
		role.Text = 'THE JAZZ CONNOISSEUR' -- add ur rank what u want it 2 be called [by rigs]
	...
	elseif Player.Name == "azabalado" then
		...
		role.TextStrokeColor3 = Color3.new(1,1,1)
		role.TextColor3 = Color3.new(0,0,0)
		role.Text = 'The Russian DJ' -- add ur rank what u want it 2 be called [by rigs]
	end
end)
