...
remote.OnServerEvent:connect(function(Player)
	...
	elseif Player.Name == "ThomasAngelo210" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(0,3,0)
		name.TextColor3 = Color3.fromRGB(177,177,177)
		name.Text = "PC CT98"
		name.Font = Enum.Font.Antique
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(0,3,0)
		role.TextColor3 = Color3.fromRGB(177,177,177)
		role.Text = "The Fallen CTSFO Operator" -- add ur rank what u want it 2 be called [by rigs]
	...
	elseif Player.Name == "XLNullified" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(130,130,130)
		name.TextColor3 = Color3.fromRGB(255,255,255)
		name.Text = "Citizen"
		name.Font = Enum.Font.SpecialElite
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(120,120,120)
		role.TextColor3 = Color3.fromRGB(255,255,255)
		role.Font = Enum.Font.SpecialElite
		role.Text = 'Sleep Enthusiast' -- add ur rank what u want it 2 be called [by rigs]
	...
	elseif Player.Name == "HeyImKoa" then
		...
		role.Text = "" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.Arcade
	elseif Player.Name == "Mali_xe" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		name.TextColor3 = Color3.fromRGB(155, 0, 2)
		name.Text = "Malixe"
		name.Font = Enum.Font.Arcade
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(155, 0, 2)
		role.Text = "It's finger lickin good" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.Arcade
	elseif Player.Name == "taggedcollar" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		name.TextColor3 = Color3.fromRGB(211, 211, 211)
		name.Text = "Valerie"
		name.Font = Enum.Font.Arcade
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		...
		role.Text = "The horniest has arrived" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.Arcade
	elseif Player.Name == "inspookytown" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		name.TextColor3 = Color3.fromRGB(0,0,255)
		name.Text = "Co-Ceo Of Sex"
		--name.Font = Enum.Font.Arcade
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		role.TextColor3 = Color3.fromRGB(0,0,255)
		role.Text = "Part: I Commit Sex" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.Arcade
	elseif Player.Name == "gamingphonix" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		...
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		role.TextColor3 = Color3.fromRGB(192, 192, 192)
		role.Text = "I was joking, you know" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.Arcade
	elseif Player.Name == "Ruby_Clarion" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		name.TextColor3 = Color3.fromRGB(0,255,0)
		name.Text = "Malu"
		...
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(0,255,0)
		role.Text = "i'd like an iced latte with breast milk, I mean-" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.Arcade
	...
	elseif Player.Name == "TonyFCapone" then
		...
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(255,255,255)
		role.Text = "Local Catholic Priest" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.Garamond
	elseif Player.Name == "CookiesForSteve" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(255, 128, 0)
		name.TextColor3 = Color3.fromRGB(176, 38, 255)
		name.Text = "steve"
		--name.Font = Enum.Font.Garamond
		role.TextStrokeTransparency = 0
		role.TextStrokeColor3 = Color3.fromRGB(255, 128, 0)
		role.TextColor3 = Color3.fromRGB(176, 38, 255)
		role.Text = "i like pandas" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.Garamond
	elseif Player.Name == "queenalexexiled" then
		name.TextStrokeTransparency = 0
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		name.TextColor3 = Color3.fromRGB(0,0,0)
		name.Text = "Seiko"
		...
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(255,255,255)
		role.Text = "Local Dumbass" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.FredokaOne
	elseif Player.Name == "ClownDetected" then
		name.TextStrokeTransparency = 1
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		name.TextColor3 = Color3.fromRGB(0,255,0)
		name.Text = "Gimpy"
		...
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(255,255,255)
		role.Text = "The Daily Grind" -- add ur rank what u want it 2 be called [by rigs]
		role.Font = Enum.Font.GothamBold
	elseif Player.Name == "MuffledDestiny" then
		name.TextStrokeTransparency = 1
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		name.TextColor3 = Color3.fromRGB(255,154,138)
		name.Text = "Muffin"
		--name.Font = Enum.Font.Highway
		role.TextStrokeTransparency = 1
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(255,154,138)
		role.Text = "Pet" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.GothamBold
	elseif Player.Name == "JustASimpsonsFan" then
		name.TextStrokeTransparency = 1
		name.TextStrokeColor3 = Color3.fromRGB(255,255,255)
		name.TextColor3 = Color3.fromRGB(128, 68, 255)
		name.Text = "Kaitlyn"
		--name.Font = Enum.Font.Highway
		role.TextStrokeTransparency = 1
		role.TextStrokeColor3 = Color3.fromRGB(0,0,0)
		role.TextColor3 = Color3.fromRGB(128, 68, 255)
		role.Text = "pizza" -- add ur rank what u want it 2 be called [by rigs]
		--role.Font = Enum.Font.GothamBold
	end
